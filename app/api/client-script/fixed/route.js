...
&lt;/script&gt;</div>
  ...
  // Render the client script as JavaScript
  // Note: We're avoiding nested template literals by using string concatenation
  const clientScript = `
    ...
    (function() {
      ...
      Object.assign(AICRO, {
        ...
        getBookmarklet: function() {
          window.open('${finalHost}/api/client-script/fixed?bookmarklet=true', '_blank');
          return this;
        },
        ...
        getBookmarkletCode: function() {
          const bookmarkletCode = '(function() { var script = document.createElement(\\'script\\'); script.src = \\'${finalHost}/api/selector-module/simple\\'; document.head.appendChild(script); })();';
        ...
        showBookmarkletHelper: function() {
          ...
          // Avoiding nested backticks by using string concatenation
          panel.innerHTML = 
          ...
          if (config.debug) {
            ...
            const addButtonToDOM = function() {
              if (document && document.body) {
                ...
                // Avoiding nested backticks again
                menu.innerHTML = 
