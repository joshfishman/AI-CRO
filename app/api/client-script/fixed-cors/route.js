...
export async function GET(request) {
  ...
  if (showBookmarklet) {
    ...
    <head>
      ...
      <title>AI CRO Bookmarklet Helper (Fixed)</title>
      <style>
        body {
    ...
    <body>
      <h1>AI CRO Element Selector Bookmarklet (Fixed Version)</h1>
      
      <div class="bookmarklet-container">
        <p>Drag this button to your bookmarks bar:</p>
        <a href="${bookmarkletCode}" class="bookmarklet">AI CRO Selector (Fixed)</a>
        <p><small>This improved bookmarklet includes better error handling and debugging</small></p>
      </div>
      ...
      <div class="instructions">
        ...
        <ol>
          ...
          <li>Click the "AI CRO Selector (Fixed)" bookmark to activate the selection tool.</li>
        ...
        <div class="code">&lt;script src="${finalHost}/api/client-script/fixed-cors"&gt;&lt;/script&gt;</div>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    if (window.AICRO && typeof window.AICRO.init === 'function') {
      ...
      console.error("AICRO is not defined. Make sure the client script loaded correctly.");
    }
  });
&lt;/script&gt;</div>
      </div>
      ...
      <div class="troubleshooting">
        ...
        <ol>
          ...
          <li><strong>CORS issues:</strong> This version tries to handle CORS better, but if problems persist, you may need to use a CORS browser extension.</li>
          <li><strong>Script not working:</strong> Try the debug version which shows more information.</li>
  ...
  const clientScript = `
    ...
    // Fixed CORS version with improved error handling
    (function() {
      console.log('[AI CRO] Loading client script - fixed CORS version');
      ...
      Object.assign(AICRO, {
        ...
        getBookmarklet: function() {
          window.open('${finalHost}/api/client-script/fixed-cors?bookmarklet=true', '_blank');
          return this;
        },
      ...
      console.log('[AI CRO] Fixed CORS client script loaded. Use AICRO.debug(true).init() to initialize.');
    })();
  `;
