...
// Import handlers from existing API files in the proper Next.js location
import { default as handleGetConfig } from '../../api/get-config';
import { default as handleSaveConfig } from '../../api/save-config';
import { default as handleGetUserType } from '../../api/get-user-type';
import { default as handleGenerateVariants } from '../../api/generate-variants';
import { default as handleRecordEvent } from '../../api/record-event';
import { default as handleCacheVariants } from '../../api/cache-variants';
import { default as handleGetCachedVariants } from '../../api/get-cached-variants';
import { default as handleGetTestResults } from '../../api/get-test-results';
